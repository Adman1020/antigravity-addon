...
The Home Assistant configuration files are mounted at \`/config\`. Check this directory when you need to read or modify the user's Home Assistant YAML configuration files.
